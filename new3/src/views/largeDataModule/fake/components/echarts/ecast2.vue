...
export default {
  ...
  methods: {
    ...
    setPiechatOptions () { // 配置饼图
      ...
      let data = [{ name: '金属', value: 832512 }, { name: '衣物', value: 608024 }, { name: '纸张', value: 223669 }, { name: '塑料', value: 404211 }, { name: '大件', value: 36212 }, { name: '玻璃', value: 10853 }, { name: '厨余', value: 76224 }, { name: '毒害', value: 9962 }]
      // if (dataList.length) {
      //   dataList.map((ele) => {
