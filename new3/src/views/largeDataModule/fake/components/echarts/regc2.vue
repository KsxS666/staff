...
export default {
  ...
  methods: {
    ...
    setBarChatOptions () {
      ...
      let titleArr = ['05月', '06月', '07月', '08月', '09月', '10月', '11月', '12月', '01月', '02月', '03月', '04月']
      let percentArr = ['64%', '66%', '71%', '69%', '80%', '85%', '89%', '86%', '89%', '87%', '88%', '91%']
      let valueArr = [64, 66, 71, 69, 80, 85, 89, 86, 89, 87, 88, 91]
      if (dataList.length) {
        dataList.map((ele) => {
