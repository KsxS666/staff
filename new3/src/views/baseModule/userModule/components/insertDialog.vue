...
<template>
  <div>
    <v-dialog title="用户导入"  :visible="value" width="550px" :before-close="beforeClose">
    ...
    <v-dialog title="导入结果"  :visible="uploadRes.visible" top="calc(15vh + 100px)">
      <div v-html="uploadRes.resText" style="max-width: 100%; word-wrap: break-word"> </div>
      <div slot="footer">
...
export default {
  ...
  methods: {
    ...
    async saveData () {
      ...
      let res = await this.$post('user/user/importExcel', this.formData, true)
