<template>
  <div class="upload-container">
    ...
    <el-dialog append-to-body :visible.sync="dialogVisible" width="820px" title="选择图片">
      <el-upload class="editor-slide-upload" :action="url" :data="fileData" name="file" :multiple="true" :file-list="fileList" :show-file-list="true"
...
export default {
  ...
  data () {
    return {
      ...
      listObj: {},
      fileList: []
      // url: `${process.env.BASE_API}/system/util/upload`
    }
  },
  computed: {
    url () {
  ...
  methods: {
    ...
    handleSuccess (response, file) {
      if (!response || parseInt(response.code) !== 0) {
